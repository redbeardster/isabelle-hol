...
(******
  Note: This lists the solution of the original exercise question, 
    which I modified on the fly during the tutorial.

    The solutions that were elaborated during the tutorial are available as 
    tut11.thy.
*)  
